  ...
  const createCDNLink = (data, type, cond = '') => {
    Object.keys(data).forEach(key => {
      ...
      const cdnSource = {
		...
		onmicrosoftjsd: `https://jsd.onmicrosoft.cn/npm/${name}${verType}/${min_file}`,
		onmicrosoftnpm: `https://npm.onmicrosoft.cn/${name}${verType}/${file}`,
		sinzerocdn: `https://jsd.cdn.sininno.eu.org/npm/${name}${verType}/${min_file}`,
