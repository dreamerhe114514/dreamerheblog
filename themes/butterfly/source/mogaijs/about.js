...
var meuicat = {
	comments: function() {
		...
		.then(articleData => {
			...
			fetch('{https://tkpldreamhe.qianxun7747.eu.org/}', {
			method: "POST",
			body: JSON.stringify({ event: "GET_RECENT_COMMENTS", accessToken: "{d2814186fa62a238967cef99043e035a}", includeReply: true, pageSize: -1 }),
	...
	fiftyonela: function() {
		fetch('https://v6-widget.51.la/v6/{3HjqjuxGOyrBmTjA}/quote.js')
			.then(res => res.text())
			.then((data) => {
